...
input_anacapa_path_1 <- here("anacapa_20210516","ucsb_2018_elas_combo","c19_fishcard_taxonomy_tables","Summary_by_percent_confidence","60","c19_fishcard_ASV_raw_taxonomy_60.txt")
input_anacapa_path_2 <- here("anacapa_20210516","ucsb_2018_elas_fishcard","fishcard_12S_all_taxonomy_tables","Summary_by_percent_confidence","60","fishcard_12S_all_ASV_raw_taxonomy_60.txt")
input_anacapa_path_3 <- here("anacapa_20210516","ucsb_2018_miu_combo","c19_fishcard_taxonomy_tables","Summary_by_percent_confidence","60","c19_fishcard_ASV_raw_taxonomy_60.txt")
input_anacapa_path_4 <- here("anacapa_20210516","ucsb_2018_miu_fishcard","fishcard_12S_all_taxonomy_tables","Summary_by_percent_confidence","60","fishcard_12S_all_ASV_raw_taxonomy_60.txt")

input_meta_path <- here("metadata_ucsb_2018_032020.txt")
